...
const OrderScreen = () => {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <h1 style={{ color: "white" }}>Order ID: {order.order_id}</h1>
          ...
          <Row>
            <Col md={8}>
              <ListGroup variant="flush">
                <ListGroupItem>
                  ...
                  <p>
                    <strong>Shipping Address: </strong> {order.delivery_address}
                  </p>
                  <p>
                    <strong>Email: </strong>
            ...
            <Col md={4}>
              <ListGroup>
                ...
                <ListGroupItem>
                  <p>
                    <strong>Item Price: $</strong> {order.tot_price}
                  </p>
                </ListGroupItem>
                <ListGroupItem>
                  <strong>Shipping Cost: $</strong>0
                </ListGroupItem>
                <ListGroupItem>
                  <p style={{ fontSize: "25px", weight: "700" }}>
                    <strong>Total Price: $</strong> {order.tot_price}
                  </p>
                </ListGroupItem>
              </ListGroup>
            </Col>
  ...
  //   ) : (
  //     <>
  //       <h1 style={{ color: "white" }}>Order {order.order_id}</h1>
  //       <Row>
  //         <Col md={8}>
  //           <ListGroup variant="flush">
  //             <ListGroup.Item>
