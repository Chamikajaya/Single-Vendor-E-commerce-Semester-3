      ...
      <FormContainer>
        ...
        <Form onSubmit={submitHandler}>
          <Form.Group className="my-2" controlId="email">
            <Form.Label className="form-row">Email Address</Form.Label>
            <Form.Control
              type="email"
          ...
          <Form.Group className="my-2 form-row" controlId="password">
            <Form.Label className="form-row">Password</Form.Label>
            <Form.Control
              type="password"
